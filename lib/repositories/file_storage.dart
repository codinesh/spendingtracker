...
/// testing.
class FileStorage implements SpendingRepository {
  final String tag;
  ...
  Future<List<SpendingEntity>> loadTodos() async {
    ...
    final todos = (json['todos'])
        .map<SpendingEntity>((todo) => SpendingEntity.fromJson(todo))
        .toList();
  ...
  @override
  Future<File> saveTodos(List<SpendingEntity> todos) async {
    final file = await _getLocalFile();
